...
For tutorial regarding MySQL, refer to https://www.w3schools.com/sql/ where everything is explained from scratch. The website also has an builtin editor which will allow you to practice executing queries online.  
